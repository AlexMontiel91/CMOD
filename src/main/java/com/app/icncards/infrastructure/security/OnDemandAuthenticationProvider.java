...
public class OnDemandAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        try {
            ...
            log.info("Password vencido para usuario '{}'; se dirige a cambio de password", user);
            // NUNCA cuenta como intento fallido: el password es correcto, solo vencio.
            throw new CredentialsExpiredException("Password vencido", e);
